...
const endMarker = 'function MoonPhaseSvg({ degreeDiff }: { degreeDiff: number }) {';
    ...
    <div className="relative select-none" style={{ width: "100%", aspectRatio: "1" }}>
      ...
      <svg viewBox="0 0 1000 1000" className="w-full h-full">
        <defs>
          ...
          <path id="topTitleArch" d="M 170 420 A 370 370 0 0 1 830 420" fill="none" />
        </defs>
        ...
        {wallTime && (
          <>
            <text x="140" y="100" fill="white" fontSize="28" fontFamily="'Outfit',sans-serif" fontWeight="bold" style={{ filter: "drop-shadow(0 0 8px rgba(255,255,255,0.8))" }}>
              {fmt2(wallTime.getHours() % 12 || 12)}:{fmt2(wallTime.getMinutes())} {wallTime.getHours() >= 12 ? "PM" : "AM"}
            </text>
            <text x="860" y="100" fill="white" fontSize="26" fontFamily="'Outfit',sans-serif" fontWeight="bold" textAnchor="end" style={{ filter: "drop-shadow(0 0 8px rgba(255,255,255,0.8))" }}>
        ...
        {/* Main Title Arch */}
        <text fill="#d4af37" fontSize="48" fontWeight="900" fontFamily="'Cinzel',serif" letterSpacing="0.1em" style={{ filter: "drop-shadow(0 0 12px rgba(212,175,55,0.8))" }}>
        ...
        {panchang && (
          <>
            ...
            <g transform="translate(500, 200)">
              <circle cx="0" cy="0" r="60" fill="rgba(10,25,60,0.85)" stroke="#d4af37" strokeWidth="3" style={{ filter: "drop-shadow(0 0 20px rgba(0,150,255,0.6))" }} />
              ...
              <text y="30" textAnchor="middle" fill="white" fontSize="22" fontFamily="'Outfit',sans-serif" fontWeight="bold" style={{ filter: "drop-shadow(0 0 5px white)" }}>
            ...
            <g transform="translate(500, 310)">
              <path d="M -90 0 L 0 -20 L 90 0 L 0 20 Z" fill="rgba(212,175,55,0.15)" stroke="rgba(212,175,55,0.6)" strokeWidth="1.5" style={{ filter: "drop-shadow(0 0 10px rgba(212,175,55,0.4))" }}/>
              <text y="8" textAnchor="middle" fill="#ffd700" fontSize="26" fontFamily="'Cinzel',serif" fontWeight="bold" letterSpacing="0.15em">
            ...
            <g transform="translate(500, 460)">
               <text y="-25" textAnchor="middle" fill="white" fontSize="36" fontFamily="'Cinzel',serif" fontWeight="bold" style={{ filter: "drop-shadow(0 0 12px white)" }}>
                 {panchang.tithi.sanskrit}
               </text>
               <text y="8" textAnchor="middle" fill="#fbbf24" fontSize="24" fontFamily="'Outfit',sans-serif" fontWeight="bold" letterSpacing="0.1em">
                 {panchang.tithi.name}
               </text>
            </g>
            ...
            <g transform="translate(220, 600)">
              <circle cx="0" cy="0" r="75" fill="rgba(6,10,25,0.85)" stroke="rgba(0,150,255,0.6)" strokeWidth="3" style={{ filter: "drop-shadow(0 0 20px rgba(0,100,255,0.5))" }} />
              <text y="-10" textAnchor="middle" fill="white" fontSize="34" fontFamily="'Cinzel',serif" fontWeight="bold" style={{ filter: "drop-shadow(0 0 8px white)" }}>
                {panchang.chandraRashi.sanskrit}
              </text>
              <path d="M -45 15 L 45 15" stroke="rgba(212,175,55,0.5)" strokeWidth="2" />
              <text y="40" textAnchor="middle" fill="#d4af37" fontSize="24" fontFamily="'Outfit',sans-serif" fontWeight="bold">
                चंद्र
              </text>
            </g>
            ...
            <g transform="translate(500, 620)">
              {/* Subtle bounding box for glowing numbers */}
              <rect x="-240" y="-70" width="480" height="120" rx="20" fill="rgba(0,0,0,0.65)" stroke="rgba(212,175,55,0.4)" strokeWidth="2" style={{ filter: "drop-shadow(0 0 20px rgba(212,175,55,0.15))" }} />
              ...
              <g transform="translate(0, 85)">
                <text x="-140" y="0" textAnchor="middle" fill="#ffd700" fontSize="24" fontWeight="bold" letterSpacing="0.05em">मुहूर्त</text>
                <text x="0" y="0" textAnchor="middle" fill="#ffd700" fontSize="24" fontWeight="bold" letterSpacing="0.05em">कला</text>
                <text x="140" y="0" textAnchor="middle" fill="#ffd700" fontSize="24" fontWeight="bold" letterSpacing="0.05em">काष्ठा</text>
            ...
            <g transform="translate(500, 780)">
               ...
               <text x="0" y="30" textAnchor="middle" fill="white" fontSize="28" fontWeight="bold" fontFamily="'Cinzel',serif" letterSpacing="0.1em">
            ...
            <g transform="translate(200, 850)">
              <text x="0" y="0" textAnchor="middle" fill="#60a5fa" fontSize="38" fontWeight="bold" fontFamily="'Outfit',sans-serif" style={{ filter: "drop-shadow(0 0 15px rgba(96,165,250,0.8))" }}>
            ...
            <g transform="translate(500, 890)">
               <path d="M -160 -30 L 160 -30 L 180 0 L 160 30 L -160 30 L -180 0 Z" fill="rgba(212,175,55,0.2)" stroke="rgba(212,175,55,0.8)" strokeWidth="2" style={{ filter: "drop-shadow(0 0 10px rgba(212,175,55,0.4))" }}/>
               <text x="0" y="10" textAnchor="middle" fill="#ffd700" fontSize="28" fontWeight="bold" fontFamily="'Cinzel',serif" letterSpacing="0.05em">
...
console.log('Replaced ClockTowerDial');
